...
func (mr *MockQUICConnMockRecorder) CloseNoError() *MockQUICConnCloseNoErrorCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CloseNoError", reflect.TypeOf((*MockQUICConn)(nil).CloseNoError))
	return &MockQUICConnCloseNoErrorCall{Call: call}
}

// MockQUICConnCloseNoErrorCall wrap *gomock.Call
type MockQUICConnCloseNoErrorCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockQUICConnCloseNoErrorCall) Return() *MockQUICConnCloseNoErrorCall {
	c.Call = c.Call.Return()
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockQUICConnCloseNoErrorCall) Do(f func()) *MockQUICConnCloseNoErrorCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockQUICConnCloseNoErrorCall) DoAndReturn(f func()) *MockQUICConnCloseNoErrorCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
